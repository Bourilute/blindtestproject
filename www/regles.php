...
<main class="regle">
	...
	<section class="text">
		<h1><span>Bienvenue sur BlindQuizz!</span></h1>

		<h2>Comment Jouer?</h2>

		<p>Pour jouer, rien de plus simple, munissez-vous de vos connaissances musicales et d’une souris. Pour lancer une partie il vous suffit de choisir une des playlists situées sur la page d’accueil. Après avoir effectué votre choix, cliquez sur cette playlist et c’est parti! 
		</p>

		<h2>Quelles sont les règles du jeu?</h2>
